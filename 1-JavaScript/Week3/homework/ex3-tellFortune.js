...
function main() {
  const numKids = ['no', 2, 3, 5, 9];

  const partnerNames = ['Aria', 'Amelia', 'Avery', 'Anna', 'Angelica'];

  const locations = ['Amsterdam', 'Istanbul', 'Paris', 'London', 'NYC'];

  const jobTitles = ['developer', 'author', 'lawyer', 'doctor', 'jobless'];
